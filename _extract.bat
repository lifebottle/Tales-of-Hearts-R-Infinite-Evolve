...
::pushd "0_tohdata_dir/tohdata_release/_Data/Sound/Se"
::for /f "tokens=1* delims=." %%f in ('dir /b /a-d') do (
::	pushd "tools/Audio/Audio_Dat_Script"
::    ::PSVita_at9tool.exe -d "../../../../../0_tohdata_dir/tohdata_release/_Data/Field/Voice/00/%%f.at9" "../../../../../1_extracted/Sound/00/%%f.wav"
::	::python AudioDatSplitter.py "../../../0_tohdata_dir/tohdata_release/_Data/Sound/Se/%%f.dat" "../../../0_tohdata_dir/tohdata_release/_Data/Sound/Se/temp/%%f" %%f
::	python RiffSpliter.py "../../../0_tohdata_dir/tohdata_release/_Data/Sound/Se/temp/%%f/%%f.riff" "../../../0_tohdata_dir/tohdata_release/_Data/Sound/Se/temp/%%f" %%f
::	popd
::)
::popd
